export const translations = {
  en: {
    ...
    company: "HeresTomorrow",
    phone: "+55 (11) 98272-3837",
    ...
    news: {
      title: "Latest News",
      subtitle: "Industry insights and updates from trusted technology sources",
      viewMore: "View More",
    ...
    contact: {
      title: "Get in Touch",
      subtitle: "We're ready to help with your technology needs",
      phone: "Phone",
      email: "Email",
    ...
    footer: {
      ...
      rights: "© 2024 HeresTomorrow. All rights reserved.",
    },
  },
  es: {
    nav: {
    ...
    news: {
      ...
      subtitle: "Perspectivas de la industria y actualizaciones de fuentes de tecnología confiables",
      viewMore: "Ver Más",
    ...
    contact: {
      ...
      subtitle: "Estamos listos para ayudar con sus necesidades tecnológicas",
      phone: "Teléfono",
    ...
    footer: {
      ...
      rights: "© 2024 HeresTomorrow. Todos los derechos reservados.",
    },
  },
  pt: {
    nav: {
    ...
    news: {
      ...
      subtitle:
        "Insights de indústria e atualizações de fontes de tecnologia confiáveis",
      viewMore: "Ver Mais",
    ...
    contact: {
      ...
      subtitle: "Estamos prontos para ajudar com suas necessidades tecnológicas",
      phone: "Telefone",
      email: "E-mail",
    ...
    footer: {
      ...
      rights: "© 2024 HeresTomorrow. Todos os direitos reservados.",
    },
  },
  it: {
    nav: {
    ...
    news: {
      ...
      subtitle:
        "Approfondimenti del settore e aggiornamenti da fonti tecnologiche affidabili",
    ...
    contact: {
      ...
      subtitle: "Siamo pronti ad aiutarti con le tue esigenze tecnologiche",
      phone: "Telefono",
      email: "Email",
    ...
    footer: {
      ...
      rights: "© 2024 HeresTomorrow. Tutti i diritti riservati.",
    },
  },
  fr: {
    nav: {
    ...
    news: {
      ...
      subtitle:
        "Perspectives de l'industrie et mises à jour de sources technologiques fiables",
      viewMore: "Voir Plus",
    ...
    contact: {
      ...
      subtitle: "Nous sommes prêts à vous aider avec vos besoins technologiques",
      phone: "Téléphone",
      email: "E-mail",
    ...
    footer: {
      ...
      rights: "© 2024 HeresTomorrow. Tous droits réservés.",
    },
  },
};
